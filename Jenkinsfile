  ...
  stages {
    stage('TokenGet') {
      steps {
        ...
        echo '$ReturnStatus'
        powershell(script: 'curl --silent --location --request POST \'https://testeqdepot.sugarondemand.com/rest/v11/oauth2/token?username=dm1&grant_type=password&client_id=sugar&password=Suavis*123&platform=apiCRM\' \\ --header \'Cookie: PHPSESSID=b158d610-fcae-4501-976a-e767693c1c95; download_token_apiCRM=bc5f3734-883a-43cd-b996-d146cd246d6b; download_token_base=9812811e-6dbb-48e1-842f-a99237bc7be1\'', returnStatus: true, returnStdout: true)
      }
    }
